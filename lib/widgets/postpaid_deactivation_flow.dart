    ...
    return Dialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: widget.isDark ? const Color(0xFF242527) : Colors.white,
  ...
  Widget _buildSelectorStep(Color titleColor, Color subtitleColor) {
    return Padding(
      ...
      child: Column(
        ...
        // Sub-toggle for Success vs Error outcome
        Row(
          ...
          children: [
            Center(
              child: Container(
                ...
                child: const Icon(Icons.warning_amber_rounded, color: Color(0xFFFF9500), size: 32.0),
              ),
            ),
            ...
            Text(
              ...
              textAlign: TextAlign.center,
              style: TextStyle(fontFamily: 'Poppins', fontSize: 15.0, fontWeight: FontWeight.w600, color: titleColor),
            ),
            const SizedBox(height: 8.0),
            Text(
              'No es posible pasar a pre-pago debido a que hay un adeudo en tu cuenta actual.',
              textAlign: TextAlign.center,
              style: TextStyle(fontFamily: 'Poppins', fontSize: 12.0, color: subtitleColor),
            ),
            const SizedBox(height: 20.0),
            ElevatedButton(
              onPressed: () {
              ...
              child: const Text('Pagar adeudo y pasar a pre-pago',
                  style: TextStyle(fontFamily: 'Poppins', fontSize: 13.0, fontWeight: FontWeight.w600)),
            ),
            const SizedBox(height: 4.0),
            TextButton(
              onPressed: () => Navigator.pop(context),
              style: TextButton.styleFrom(foregroundColor: subtitleColor, padding: const EdgeInsets.symmetric(vertical: 8.0)),
              child: const Text('Salir', style: TextStyle(fontFamily: 'Poppins', fontSize: 13.0, fontWeight: FontWeight.w500)),
            ),
          ],
        ),
      ),
          ...
          children: [
            Center(
              child: Container(
                ...
                child: const Icon(Icons.swap_horizontal_circle_outlined, color: Color(0xFF6226A6), size: 32.0),
              ),
            ),
            const SizedBox(height: 14.0),
            Text(
            ...
            TextButton(
              onPressed: () => Navigator.pop(context),
              style: TextButton.styleFrom(foregroundColor: subtitleColor, padding: const EdgeInsets.symmetric(vertical: 8.0)),
              child: const Text('Cancelar', style: TextStyle(fontFamily: 'Poppins', fontSize: 13.0, fontWeight: FontWeight.w500)),
            ),
          ],
        ),
      ),
          ...
          children: [
            Center(
              child: Container(
                padding: const EdgeInsets.all(12.0),
                decoration: BoxDecoration(
                  color: const Color(0xFFE25C5C).withOpacity(0.15),
                  shape: BoxShape.circle,
                ),
                child: const Icon(Icons.error_outline_rounded, color: Color(0xFFE25C5C), size: 32.0),
              ),
            ),
            const SizedBox(height: 14.0),
            Text(
          ...
          children: [
            Center(
              child: Container(
                ...
                child: const Icon(Icons.check_circle_outline_rounded, color: Color(0xFF34C759), size: 32.0),
              ),
            ),
            const SizedBox(height: 14.0),
            Text(
